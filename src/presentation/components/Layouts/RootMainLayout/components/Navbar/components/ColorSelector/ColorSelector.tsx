...
import { AVAILABLE_THEMES, COLOR_PALETTES, ColorTheme } from "@/presentation/data/colorPalettes";
...
export default function ColorSelector() {
  ...
  useEffect(() => {
    const savedTheme = (localStorage.getItem("alioth-color-theme") as ColorTheme) || "primary";
