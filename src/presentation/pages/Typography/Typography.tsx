  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg p-8 transition-colors duration-300 space-y-12">
      ...
      <header className="border-b border-neutral-200 dark:border-neutral-700 pb-6">
        <h1 className="text-neutral-900 dark:text-neutral-100 mb-2">🅰️ Tipografía</h1>
      ...
      <section>
        <h2 className="text-neutral-900 dark:text-neutral-100 mb-6">Headings - Estilos Base</h2>
      ...
      <section>
        <h2 className="text-neutral-900 dark:text-neutral-100 mb-6">Body - Estilos Base</h2>
        <div className="space-y-6">
      ...
      <section>
        <h2 className="text-neutral-900 dark:text-neutral-100 mb-4">Variantes Funcionales</h2>
        <p className="text-neutral-600 dark:text-neutral-400 mb-6">Usamos para apoyar jerarquías o adaptarnos a casos especiales.</p>

        {/* Headings Variants */}
        <div className="mb-8">
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">Headings - Variantes</h3>
        ...
        {/* Body Variants */}
        <div>
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">Body - Variantes</h3>
          <div className="space-y-4">
            {Object.entries(TYPOGRAPHY_CONFIG.body).map(([key, style]) =>
              style.variants?.map((variant, index) => (
                <div
      ...
      <section>
        <h2 className="text-neutral-900 dark:text-neutral-100 mb-6">🖋 Ejemplos de Uso Tipográfico</h2>

        {/* Encabezados */}
        <div className="mb-8">
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">Encabezados</h3>
          <div className="space-y-6">
        ...
        {/* Párrafos */}
        <div className="mb-8">
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">Párrafos</h3>
          <div className="space-y-6">
        ...
        {/* Listas */}
        <div className="mb-8">
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">Listas</h3>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900/50">
              <h4 className="text-neutral-900 dark:text-neutral-100 mb-2">{TYPOGRAPHY_USE_CASES.lists.ordered.title}</h4>
            ...
            {/* Lista No Ordenada */}
            <div className="p-6 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900/50">
              <h4 className="text-neutral-900 dark:text-neutral-100 mb-2">{TYPOGRAPHY_USE_CASES.lists.unordered.title}</h4>
        ...
        {/* Enlaces */}
        <div className="mb-8">
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">Enlaces</h3>
          <div className="p-6 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900/50">
        ...
        {/* Notas / Informativos */}
        <div>
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">Notas / Informativos</h3>
          <div className="p-6 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900/50">
      ...
      <section>
        <h2 className="text-neutral-900 dark:text-neutral-100 mb-6">Condiciones de Uso Correcto</h2>

        <div className="grid md:grid-cols-2 gap-6">
          {/* Cuándo SÍ usarlo */}
          <div className="p-6 rounded-lg border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20">
            <h3 className="text-green-900 dark:text-green-100 mb-4">✔️ Cuándo SÍ usarlo</h3>
          ...
          <div className="p-6 rounded-lg border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20">
            <h3 className="text-red-900 dark:text-red-100 mb-4">❌ Cuándo NO usarlo</h3>
        ...
        <div className="mt-6 p-6 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900/50">
          <h3 className="text-neutral-900 dark:text-neutral-100 mb-4">🧪 Principios de Font-Size y Line-Height</h3>
      ...
      <footer className="border-t border-neutral-200 dark:border-neutral-700 pt-6">
        <div className="p-6 rounded-lg bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
          <h3 className="text-primary-900 dark:text-primary-100 mb-2">👉 Conclusión</h3>
